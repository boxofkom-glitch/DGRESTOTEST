...
const PLAYBOOKS = {
  'Suivi de vos coûts (food cost, marges par plat)': {
    ...
    weeks: [
      ...
      ["Point mensuel : revue des chiffres et ajustement du plan.", "Calculer le food cost moyen réel du mois et le comparer à l'objectif.", "Identifier les 2 plats ayant le plus progressé en marge.", "Lister les actions à poursuivre le mois suivant.", "Valider les nouveaux prix ou portions avec l'équipe.", "Archiver les fiches techniques mises à jour.", "Préparer les 3 priorités food cost du mois suivant avec votre coach."]
    ]
  },
  'Organisation de l\'équipe (plannings, rôles clairs)': {
    ...
    weeks: [
      ...
      ["Ajuster l'organisation selon les retours et fixer la version stable.", "Valider le planning type définitif avec toute l'équipe.", "Calculer le total d'heures supplémentaires du mois.", "Mesurer le taux d'absentéisme du mois.", "Identifier si un recrutement ou une formation est nécessaire.", "Documenter les rôles clarifiés dans un support simple (1 page).", "Fixer les priorités organisation du mois suivant avec votre coach."]
    ]
  },
  'Visibilité en ligne (Google, réseaux sociaux, avis)': {
    ...
    weeks: [
      ...
      ["Bilan visibilité : évolution des vues et des avis sur le mois.", "Calculer le nombre total de nouveaux avis obtenus sur le mois.", "Comparer la note Google en début et fin de mois.", "Identifier le post ou la photo ayant le mieux fonctionné.", "Lister les annuaires encore à corriger le mois suivant.", "Valider le rythme de publication à conserver.", "Fixer les priorités visibilité du mois suivant avec votre coach."]
    ]
  },
  ...
  'Suivi mensuel de vos chiffres': {
    ...
    weeks: [
      ...
      ["Premier point mensuel chiffré complet avec le coach.", "Présenter les indicateurs clés du mois (CA, marge, trésorerie).", "Identifier les 2 chiffres les plus préoccupants du mois.", "Identifier les 2 chiffres les plus positifs du mois.", "Décider des ajustements à apporter au tableau de bord.", "Valider le format définitif du tableau pour les mois suivants.", "Fixer les priorités pilotage du mois suivant avec votre coach."]
    ]
  },
  'Clarté de vos objectifs chiffrés': {
    ...
    weeks: [
      ...
      ["Valider le plan d'objectifs avec le coach et ajuster si besoin.", "Mesurer l'avancement réel du levier prioritaire sur le mois.", "Comparer cet avancement à l'objectif du palier à 3 mois.", "Ajuster les paliers si les premiers résultats le justifient.", "Documenter les objectifs chiffrés finaux dans un support simple.", "Partager la version finale avec l'équipe si pertinent.", "Fixer les priorités pilotage des objectifs pour le mois suivant."]
    ]
  }
};
